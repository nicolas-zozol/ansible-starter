...
alias tohk='cd /linux/hk'
alias gst='git status'
alias tomongo='cd /linux/hk/docker/ansible/hk-mongo-project/'


#Consolabel
alias tojs='cd /linux/store-gateway/src/path/src/Consolabel/GatewayBundle/Resources/public/js'
